...
export type {
    TiptapTextStyleCssProperty,
    TiptapTextStyleDefinition,
} from './text-style-definition.js';
export {
    DEFAULT_TIPTAP_TEXT_STYLE_TOOLBAR_CONFIG,
    resolveTiptapTextStyleToolbarConfig,
} from './text-style-toolbar.js';
export type {
    TiptapTextStyleColorOption,
    TiptapTextStyleOption,
    TiptapTextStyleToolbarConfig,
} from './text-style-toolbar.js';
export type {
    TiptapDocumentSurface,
