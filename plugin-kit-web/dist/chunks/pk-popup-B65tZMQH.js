import { a as query, i as property, n as PkElement, s as customElement, t as __decorate } from "./decorate-R0X811qp.js";
...
import { arrow, autoUpdate, computePosition, flip, getOverflowAncestors, offset, platform, shift, size } from "@floating-ui/dom";
	...
	async repositionAsync(emitEvent = true) {
		...
		if (this.autoSize) middleware.push(size({
			...
			apply: ({ availableHeight, availableWidth }) => {
				...
				if (constrainWidth) floatingElement.style.setProperty("--pk-popup-available-width", `${Math.max(0, Math.floor(availableWidth))}px`);
				else floatingElement.style.removeProperty("--pk-popup-available-width");
				if (constrainHeight) floatingElement.style.setProperty("--pk-popup-available-height", `${Math.max(0, Math.floor(availableHeight))}px`);
				else floatingElement.style.removeProperty("--pk-popup-available-height");
			}
		}));
		else {
		...
		const getOffsetParentFn = SUPPORTS_POPOVER ? (element) => platform.getOffsetParent(element, offsetParent) : platform.getOffsetParent;
...
__decorate([property()], PkPopup.prototype, "anchor", void 0);
__decorate([property({
	type: Boolean,
	reflect: true
})], PkPopup.prototype, "active", void 0);
__decorate([property({ attribute: "position-method" })], PkPopup.prototype, "positionMethod", void 0);
__decorate([property({ reflect: true })], PkPopup.prototype, "boundary", void 0);
__decorate([property({ reflect: true })], PkPopup.prototype, "placement", void 0);
__decorate([property({ type: Number })], PkPopup.prototype, "distance", void 0);
__decorate([property({ type: Number })], PkPopup.prototype, "skidding", void 0);
__decorate([property({ type: Boolean })], PkPopup.prototype, "flip", void 0);
__decorate([property({ attribute: "flip-fallback-placements" })], PkPopup.prototype, "flipFallbackPlacements", void 0);
__decorate([property({ attribute: "flip-fallback-strategy" })], PkPopup.prototype, "flipFallbackStrategy", void 0);
__decorate([property({
	attribute: "flip-padding",
	type: Number
})], PkPopup.prototype, "flipPadding", void 0);
__decorate([property({ type: Boolean })], PkPopup.prototype, "shift", void 0);
__decorate([property({
	attribute: "shift-padding",
	type: Number
})], PkPopup.prototype, "shiftPadding", void 0);
__decorate([property({ type: Boolean })], PkPopup.prototype, "arrow", void 0);
__decorate([property({ attribute: "arrow-placement" })], PkPopup.prototype, "arrowPlacement", void 0);
__decorate([property({
	attribute: "arrow-padding",
	type: Number
})], PkPopup.prototype, "arrowPadding", void 0);
__decorate([property()], PkPopup.prototype, "sync", void 0);
__decorate([property({ attribute: "auto-size" })], PkPopup.prototype, "autoSize", void 0);
__decorate([property({
	attribute: "auto-size-padding",
	type: Number
})], PkPopup.prototype, "autoSizePadding", void 0);
__decorate([property({
...
__decorate([query(".popup")], PkPopup.prototype, "popupElement", void 0);
__decorate([query(".arrow")], PkPopup.prototype, "arrowElement", void 0);
PkPopup = __decorate([customElement("pk-popup")], PkPopup);
//#endregion
export { PkRepositionEvent as n, resolveElementById as r, PkPopup as t };

//# sourceMappingURL=pk-popup-B65tZMQH.js.map