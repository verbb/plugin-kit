...
import { r as buttonGroupCornerRoleStyles } from "./button-group-item.styles-DYmBR28a.js";
import { t as activeElements } from "./active-elements-BwpXu8Lb.js";
...
import { r as resolveElementById } from "./pk-popup-B9AgBC2V.js";
import { i as waitForPopupReposition } from "./popup-placement-animation-WlEXnS85.js";
import { t as animateWithClass } from "./animate-with-class-ZJeCOKB3.js";
import { n as dropdownMenuHostSizeStyles, r as dropdownMenuPanelSizeStyles, t as PkDropdownItem } from "./pk-dropdown-item-BoZTGWMU.js";
...
__decorate([property({ reflect: true })], PkDropdownMenu.prototype, "size", void 0);
__decorate([property({ reflect: true })], PkDropdownMenu.prototype, "placement", void 0);
__decorate([property({
	attribute: "side-offset",
	type: Number
})], PkDropdownMenu.prototype, "sideOffset", void 0);
__decorate([property({ type: Number })], PkDropdownMenu.prototype, "distance", void 0);
__decorate([property({ type: Number })], PkDropdownMenu.prototype, "skidding", void 0);
__decorate([property({ reflect: true })], PkDropdownMenu.prototype, "for", void 0);
__decorate([query("slot:not([name])")], PkDropdownMenu.prototype, "defaultSlot", void 0);
__decorate([query("#menu")], PkDropdownMenu.prototype, "menuElement", void 0);
__decorate([query("pk-popup")], PkDropdownMenu.prototype, "popupElement", void 0);
PkDropdownMenu = __decorate([customElement("pk-dropdown-menu")], PkDropdownMenu);
//#endregion
export { PkDropdownMenu as t };

//# sourceMappingURL=pk-dropdown-menu-CfZc7dIz.js.map