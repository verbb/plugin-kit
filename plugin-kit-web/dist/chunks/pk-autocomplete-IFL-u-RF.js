...
import "./pk-popup-B65tZMQH.js";
import { i as waitForPopupReposition, r as syncPopupPlacementAnimation } from "./popup-placement-animation-WlEXnS85.js";
import { a as isListboxTypeToSelectKey, i as handleListboxKeyDown, n as LISTBOX_NAVIGATION_KEYS } from "./sync-listbox-separators-B1-V0oJi.js";
import { i as waitForPopupContentExitAnimation, n as AsyncOptionFetcher, r as syncFilteredOptions, t as matchesOptionFilter } from "./option-filter-BQqr8Z21.js";
import { n as isPointerInsideOverlay, t as isEventInsideOverlay } from "./popup-pointer-CuLjk1th.js";
...
*/
var pkAutocompleteStyles = [popupContentAnimationStyles, css`
    ${iconStyles}
    @layer pk-component {
        :host {
            display: block;
...
var PkAutocomplete = class PkAutocomplete extends PkFormAssociatedElement {
	...
	renderHostDecorationSlot(name) {
		if (!this.hasSlotController.test(name)) return nothing;
...
__decorate([property({ reflect: true })], PkAutocomplete.prototype, "placement", void 0);
__decorate([property({
...
__decorate([property({ reflect: true })], PkAutocomplete.prototype, "size", void 0);
__decorate([property({ reflect: true })], PkAutocomplete.prototype, "width", void 0);
__decorate([property()], PkAutocomplete.prototype, "placeholder", void 0);
__decorate([property({ attribute: "empty-message" })], PkAutocomplete.prototype, "emptyMessage", void 0);
__decorate([property()], PkAutocomplete.prototype, "value", void 0);
__decorate([property({ attribute: "default-value" })], PkAutocomplete.prototype, "defaultValue", void 0);
__decorate([property()], PkAutocomplete.prototype, "label", void 0);
__decorate([property()], PkAutocomplete.prototype, "instructions", void 0);
__decorate([property({ attribute: "aria-label" })], PkAutocomplete.prototype, "ariaLabel", void 0);
__decorate([property({
	attribute: "loop-focus",
	type: Boolean
})], PkAutocomplete.prototype, "loopFocus", void 0);
__decorate([property({ attribute: false })], PkAutocomplete.prototype, "filter", void 0);
__decorate([property({
	type: Boolean,
	reflect: true
})], PkAutocomplete.prototype, "async", void 0);
__decorate([property({ attribute: "loading-message" })], PkAutocomplete.prototype, "loadingMessage", void 0);
__decorate([property({ attribute: "start-typing-message" })], PkAutocomplete.prototype, "startTypingMessage", void 0);
__decorate([property({ attribute: false })], PkAutocomplete.prototype, "fetchOptions", void 0);
__decorate([query("pk-popup")], PkAutocomplete.prototype, "popupElement", void 0);
__decorate([query(".control")], PkAutocomplete.prototype, "controlElement", void 0);
__decorate([query(".control-input")], PkAutocomplete.prototype, "controlInput", void 0);
__decorate([query(".value-input")], PkAutocomplete.prototype, "input", void 0);
__decorate([state()], PkAutocomplete.prototype, "highlightedIndex", void 0);
__decorate([state()], PkAutocomplete.prototype, "closing", void 0);
__decorate([state()], PkAutocomplete.prototype, "panelAnimated", void 0);
__decorate([state()], PkAutocomplete.prototype, "asyncLoading", void 0);
__decorate([state()], PkAutocomplete.prototype, "asyncError", void 0);
PkAutocomplete = __decorate([customElement("pk-autocomplete")], PkAutocomplete);
//#endregion
export { PkAutocomplete as t };

//# sourceMappingURL=pk-autocomplete-IFL-u-RF.js.map