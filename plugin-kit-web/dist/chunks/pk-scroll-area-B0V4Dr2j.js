...
var PkScrollArea = class PkScrollArea extends PkElement {
	...
	render() {
		...
		return html`
            ...
            >
                ${this.withoutShadow ? nothing : html`
                ...
                ${this.withoutScrollbar ? nothing : html`
                        <div
                            part="scrollbar"
                            class=${classMap({
			scrollbar: true,
...
__decorate([property({ reflect: true })], PkScrollArea.prototype, "orientation", void 0);
__decorate([property({ reflect: true })], PkScrollArea.prototype, "size", void 0);
__decorate([property({
...
__decorate([query(".viewport")], PkScrollArea.prototype, "content", void 0);
__decorate([query(".scrollbar")], PkScrollArea.prototype, "scrollbarElement", void 0);
__decorate([query(".thumb")], PkScrollArea.prototype, "thumbElement", void 0);
__decorate([state()], PkScrollArea.prototype, "hovering", void 0);
__decorate([state()], PkScrollArea.prototype, "scrolling", void 0);
__decorate([state()], PkScrollArea.prototype, "canScroll", void 0);
PkScrollArea = __decorate([customElement("pk-scroll-area")], PkScrollArea);
//#endregion
export { PkScrollArea as t };

//# sourceMappingURL=pk-scroll-area-B0V4Dr2j.js.map