...
import "./pk-checkbox-CfV1uDdC.js";
...
import "./pk-input-CF_icEtR.js";
import "./pk-dialog-VMQqLW1f.js";
import "./pk-dropdown-item-D9OaG5o-.js";
import "./pk-dropdown-menu-DW1wI8xQ.js";
import "./pk-dropdown-label-CRNWMWQd.js";
import "../components/dropdown-menu/pk-dropdown-separator.js";
import "./pk-field-UAlMq6mQ.js";
import "./pk-tooltip--QBV6puX.js";
import { i as createVariableTagDomNodeView, r as tiptapProseMirrorStyles } from "./tiptap.styles-CPRows--.js";
import { css, html, nothing } from "lit";
import { unsafeSVG } from "lit/directives/unsafe-svg.js";
import { Editor, getMarkRange, posToDOMRect } from "@tiptap/core";
import { applyLinkToEditor, createTiptapExtensions, getCraftLinkOptions, getFatalTiptapContentError, getLinkEditState, getLinkOpenInNewTab, getLinkOptionsElementSiteId, getRegisteredTiptapToolbarControl, getSelectedText, getToolbarGroupDefaultIcon, getToolbarGroupMenuItems, getToolbarGroupTriggerState, isFormattingToolbarPreset, isHeadingsOnlyToolbarPreset, isTiptapButtonActive, isToolbarButtonActive, normalizeContentArray, openCraftElementLinkSelector, parseToolbarConfig, resolveTiptapTextStyleToolbarConfig, runToolbarButton, toolbarIncludesButton, unsetLinkFromEditor, valueToContent } from "@verbb/plugin-kit-tiptap-core";
...
var TOOLBAR_ICONS = {
	...
	"small-caps": renderIconHtml(icons_exports.smallCaps),
...
var PkTiptapEditor = class PkTiptapEditor extends PkFormAssociatedElement {
	...
	*/
	...
	renderToolbarButton(buttonName) {
		...
		if (registered?.isVisible && (!editor || !registered.isVisible(editor))) return nothing;
	...
	renderToolbarGroup(group, groupKey) {
		...
		if (!menuItems.some((entry) => entry.type === "item")) return nothing;
...
//# sourceMappingURL=pk-tiptap-editor-CTz-yfHL.js.map