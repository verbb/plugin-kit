...
__decorate([property()], PkTabBase.prototype, "value", void 0);
__decorate([property({
	type: Boolean,
	reflect: true
})], PkTabBase.prototype, "disabled", void 0);
__decorate([property({
	type: Boolean,
	reflect: true
})], PkTabBase.prototype, "selected", void 0);
__decorate([property({
	type: Number,
	attribute: "focus-index"
})], PkTabBase.prototype, "focusIndex", void 0);
__decorate([property()], PkTabBase.prototype, "panelId", void 0);
//#endregion
//#region src/components/tabs/pk-tab.styles.ts
var pkTabStyles = css`
    @layer pk-component {
        :host {
...
`;
//#endregion
//#region src/components/tabs/pk-tab.ts
var PkTab = class PkTab extends PkTabBase {
	static {
		this.styles = pkTabStyles;
	}
	render() {
		return this.renderTrigger("trigger pk-tabs__trigger");
	}
};
PkTab = __decorate([customElement("pk-tab")], PkTab);
//#endregion
export { PkTab as t };

//# sourceMappingURL=pk-tab-CzV7pOdp.js.map