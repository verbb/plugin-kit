import { i as property, n as PkElement, o as state, r as hostDisplayInlineBlock, s as customElement, t as __decorate } from "./decorate-R0X811qp.js";
import { n as resolveSpinnerVariant, t as getButtonSpinnerSize } from "./spinner-utils-CDfHypTv.js";
import "./pk-spinner-DweuYJ_Z.js";
import { t as iconStyles } from "./icon.styles-BLTWLqYp.js";
import { i as buttonGroupIndentStyles, n as buttonGroupCornerRadiusStyles, r as buttonGroupCornerRoleStyles, t as buttonGroupBorderJoinStyles } from "./button-group-item.styles-DYmBR28a.js";
	...
	*/
	...
	renderInner(spinnerSize, spinnerVariant) {
		return html`
            ...
            ${this.withCaret || this.groupTrigger ? html`<span part="caret" class="caret">${unsafeSVG(CARET_ICON)}</span>` : nothing}
        `;
	}
};
__decorate([property({ reflect: true })], PkButton.prototype, "variant", void 0);
__decorate([property({ reflect: true })], PkButton.prototype, "size", void 0);
__decorate([property({
	type: Boolean,
	reflect: true
...
__decorate([property()], PkButton.prototype, "href", void 0);
__decorate([property()], PkButton.prototype, "target", void 0);
__decorate([property()], PkButton.prototype, "rel", void 0);
__decorate([property()], PkButton.prototype, "name", void 0);
__decorate([property()], PkButton.prototype, "value", void 0);
__decorate([property()], PkButton.prototype, "title", void 0);
__decorate([property({ attribute: "aria-label" })], PkButton.prototype, "ariaLabel", void 0);
__decorate([property()], PkButton.prototype, "type", void 0);
__decorate([property({ reflect: true })], PkButton.prototype, "form", void 0);
__decorate([state()], PkButton.prototype, "hasDefaultSlotContent", void 0);
__decorate([state()], PkButton.prototype, "hasStartSlotContent", void 0);
__decorate([state()], PkButton.prototype, "hasEndSlotContent", void 0);
PkButton = __decorate([customElement("pk-button")], PkButton);
//#endregion
export { PkButton as t };

//# sourceMappingURL=pk-button-BrH4u4Qr.js.map