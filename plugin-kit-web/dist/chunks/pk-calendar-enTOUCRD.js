...
var CHEVRON_LEFT = renderIconHtml(icons_exports.chevronLeft);
var CHEVRON_RIGHT = renderIconHtml(icons_exports.chevronRight);
var PkCalendar = class PkCalendar extends PkElement {
	...
	renderDayContent(state) {
		...
		if (this.daySlotNames.includes(slotName)) return html`<slot name=${slotName}></slot>`;
		const custom = this.dayContent?.(state.date);
		if (custom) return unsafeHTML(custom);
		return html`<span part="day-label">${state.date.getDate()}</span>`;
	}
	renderDay(state) {
		if (!this.withOutsideDays && state.outside) return html`<span part="day-placeholder" class="day is-placeholder" aria-hidden="true"></span>`;
	...
	renderMonth(monthAnchor, showLabel = false) {
		...
		return html`
            <div part="month" class="month">
                ${showLabel ? html`<div part="month-label" class="month-label">${title}</div>` : nothing}
                <div part="weekdays" class="weekdays" role="row">
                    ${this.withWeekNumbers ? html`<span part="weeknumbers" class="weeknumber-header" role="columnheader">#</span>` : nothing}
                ...
                >
                    ${weeks.map((week) => html`
                        <div part="week" class="week" role="row">
                            ${this.withWeekNumbers ? html`<span part="weeknumber" class="weeknumber" role="gridcell">${isoWeekNumber(week[0])}</span>` : nothing}
	...
	renderViewRows(items) {
		const rows = [];
		for (let index = 0; index < items.length; index += 3) rows.push(html`
	...
	render() {
		...
		return html`
            <div part="base" class="base">
                ...
                ${this.hasSlotController.test("footer") ? html`<div part="footer"><slot name="footer"></slot></div>` : nothing}
...
__decorate([property({ reflect: true })], PkCalendar.prototype, "mode", void 0);
__decorate([property({ reflect: true })], PkCalendar.prototype, "size", void 0);
__decorate([property({ reflect: true })], PkCalendar.prototype, "value", void 0);
__decorate([property({ reflect: true })], PkCalendar.prototype, "min", void 0);
__decorate([property({ reflect: true })], PkCalendar.prototype, "max", void 0);
__decorate([property({ reflect: true })], PkCalendar.prototype, "today", void 0);
__decorate([property({ reflect: true })], PkCalendar.prototype, "view", void 0);
__decorate([property({
	type: Number,
	reflect: true
...
__decorate([property({ attribute: "disabled-dates" })], PkCalendar.prototype, "disabledDatesRaw", void 0);
__decorate([property({
...
__decorate([property({ reflect: true })], PkCalendar.prototype, "locale", void 0);
__decorate([property({ attribute: false })], PkCalendar.prototype, "isDateDisabled", void 0);
__decorate([property({ attribute: false })], PkCalendar.prototype, "dayContent", void 0);
__decorate([state()], PkCalendar.prototype, "viewAnchor", void 0);
__decorate([state()], PkCalendar.prototype, "rangeAnchor", void 0);
__decorate([state()], PkCalendar.prototype, "hoverDate", void 0);
__decorate([state()], PkCalendar.prototype, "liveAnnouncement", void 0);
__decorate([state()], PkCalendar.prototype, "focusedMonth", void 0);
__decorate([state()], PkCalendar.prototype, "focusedYear", void 0);
...
//# sourceMappingURL=pk-calendar-enTOUCRD.js.map