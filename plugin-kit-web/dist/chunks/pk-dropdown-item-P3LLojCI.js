...
var dropdownMenuHostSizeStyles = css`
    @layer pk-component {
        :host {
...
*/
var dropdownMenuPanelSizeStyles = css`
    @layer pk-component {
...
__decorate([property()], PkDropdownItem.prototype, "value", void 0);
__decorate([property({ reflect: true })], PkDropdownItem.prototype, "type", void 0);
__decorate([property({ attribute: "radio-group" })], PkDropdownItem.prototype, "radioGroup", void 0);
__decorate([property({
	type: Boolean,
	reflect: true
...
__decorate([property({ type: Boolean })], PkDropdownItem.prototype, "active", void 0);
__decorate([state()], PkDropdownItem.prototype, "submenuAnimated", void 0);
__decorate([query(".submenu-panel")], PkDropdownItem.prototype, "submenuPanelElement", void 0);
__decorate([query("pk-popup")], PkDropdownItem.prototype, "submenuPopupElement", void 0);
PkDropdownItem = _PkDropdownItem = __decorate([customElement("pk-dropdown-item")], PkDropdownItem);
...
//# sourceMappingURL=pk-dropdown-item-P3LLojCI.js.map