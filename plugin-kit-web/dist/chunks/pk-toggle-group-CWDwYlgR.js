...
__decorate([property({ reflect: true })], PkToggleGroup.prototype, "orientation", void 0);
__decorate([property({ reflect: true })], PkToggleGroup.prototype, "variant", void 0);
__decorate([property({ reflect: true })], PkToggleGroup.prototype, "size", void 0);
__decorate([property({
	type: Number,
	reflect: true
...
__decorate([property({ type: Boolean })], PkToggleGroup.prototype, "multiple", void 0);
__decorate([property({
	type: Array,
	attribute: false
})], PkToggleGroup.prototype, "value", void 0);
__decorate([state()], PkToggleGroup.prototype, "items", void 0);
PkToggleGroup = __decorate([customElement("pk-toggle-group")], PkToggleGroup);
//#endregion
export { PkToggleGroup as t };

//# sourceMappingURL=pk-toggle-group-CWDwYlgR.js.map