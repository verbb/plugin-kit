...
export { getPortalClassName, getPortalContainer, getPortalMountElement, getPortalTargetForAppend, getShadowRootSelectors, resolvePositionMethod, setPortalClassName, setPortalContainer, setShadowRootSelectors, type PortalContainer, } from './utils/portal.js';
export * from './validators/index.js';
export * from './icons/index.js';
export { PkIcon } from './components/icon/index.js';
export { registerAll, createRegisterComponents, componentImportPaths, type PkComponentTag, } from './register.js';
