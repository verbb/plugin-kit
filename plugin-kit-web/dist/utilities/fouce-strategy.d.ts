 ...
 */
export declare const FOUCE_COLLAPSE_TAGS: readonly string[];
/**
 ...
 */
export declare const FOUCE_TRIGGER_OVERLAY_TAGS: readonly string[];
/**
 ...
 */
export declare const FOUCE_PANEL_TAGS: readonly string[];
//# sourceMappingURL=fouce-strategy.d.ts.map