...
export const COMPONENT_MODULE_PATHS: Record<string, string> = {
    ...
    'pk-autocomplete': 'components/autocomplete/autocomplete.js',
    'pk-image-browser': 'components/image-browser/image-browser.js',
...
export const LOADER_COMPONENT_ENTRIES: Record<string, string> = {
    ...
    'components/autocomplete/autocomplete': 'src/components/autocomplete/pk-autocomplete.ts',
    'components/image-browser/image-browser': 'src/components/image-browser/pk-image-browser.ts',
...
export const COMPONENT_FAMILY_ENTRIES: Record<string, string> = {
    ...
    'image-browser': 'src/components/image-browser/index.ts',
