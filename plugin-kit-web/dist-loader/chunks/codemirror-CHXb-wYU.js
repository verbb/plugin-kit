...
var descendant = new ExternalTokenizer((input) => {
	if (space$1.includes(input.peek(-1))) {
		let { next } = input;
		if (isAlpha(next) || next == underscore || next == hash || next == period || next == asterisk || next == bracketL$1 || next == colon && isAlpha(input.peek(1)) || next == dash$1 || next == ampersand) input.acceptToken(descendantOp);
	}
});
...
var defaultHighlightStyle = /* @__PURE__ */ HighlightStyle.define([
	...
	},
	{
		tag: [
			tags$1.regexp,
			tags$1.escape,
			/* @__PURE__ */ tags$1.special(tags$1.string)
		],
		color: "#e40"
	},
	{
...
var cssLanguage = /* @__PURE__ */ LRLanguage.define({
	name: "css",
	parser: /* @__PURE__ */ parser$3.configure({ props: [/* @__PURE__ */ indentNodeProp.add({ Declaration: /* @__PURE__ */ continuedIndent() }), /* @__PURE__ */ foldNodeProp.add({ "Block KeyframeList": foldInside })] }),
	languageData: {
		commentTokens: { block: {
			open: "/*",
			close: "*/"
...
//#endregion
export { keyName as C, base as S, EditorState as T, highlightActiveLine as _, html as a, keymap as b, closeBracketsKeymap as c, defaultHighlightStyle as d, indentOnInput as f, drawSelection as g, EditorView as h, json as i, css as l, syntaxHighlighting as m, history as n, javascript as o, indentUnit as p, historyKeymap as r, closeBrackets as s, defaultKeymap as t, bracketMatching as u, highlightActiveLineGutter as v, Compartment as w, lineNumbers as x, highlightSpecialChars as y };
