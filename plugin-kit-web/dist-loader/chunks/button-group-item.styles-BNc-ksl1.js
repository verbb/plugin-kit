import { h as r, m as i } from "./lit-Dnn7gEi2.js";
//#region src/components/button-group/button-group-item.styles.ts
/**
...
*/
function buttonGroupCornerRadiusStyles(surfaceSelector, fallbackRadius = "var(--pk-btn-radius, var(--pk-radius-lg))") {
	const surface = r(surfaceSelector);
	const fallback = r(fallbackRadius);
	return i`
        ${surface} {
...
function buttonGroupCornerRoleStyles() {
	return i`
...
function buttonGroupIndentStyles() {
	return i`
...
function buttonGroupBorderJoinStyles(surfaceSelector) {
	const surface = r(surfaceSelector);
	return i`
...
//#endregion
export { buttonGroupIndentStyles as i, buttonGroupCornerRadiusStyles as n, buttonGroupCornerRoleStyles as r, buttonGroupBorderJoinStyles as t };
