...
*/
var pkImageBrowserStyles = [popupContentAnimationStyles, i`
    ${iconStyles}
    @layer pk-component {
        :host {
...
var PkImageBrowser = class PkImageBrowser extends PkFormAssociatedElement {
	...
	renderPreview(preview, className) {
		if (!preview) return A;
		if (isInlineSvg(preview)) return b`<span class=${className} aria-hidden="true">${o(preview)}</span>`;
		return b`<img class=${className} src=${preview} alt="" />`;
	}
	usesInlineLabels() {
				...
				return b`
					...
					"is-selected": selected
                            ...
                            >
                                ...
                                ${this.usesInlineLabels() ? b`<span class="option-label" aria-hidden="true">${item.label}</span>` : A}
                            </button>
                        `;
			});
			return b`
                        <div
                            class="group"
                            role=${group.name ? "group" : A}
                            aria-labelledby=${group.name ? headingId : A}
                        >
                            ${group.name ? b`
                                    <h6 class="group-heading" id=${headingId}>
                                        <span>${group.name}</span>
                                        ${group.items.length < group.total ? b`
		...
		return b`
            ...
            >
                ...
                <button
                    ...
                    @click=${this.togglePanel}
                >
                    <span class="expand-button-icon">${o(CHEVRON_ICON)}</span>
                </button>
            </div>
            <pk-popup
                .active=${panelActive}
			...
			closing: this.closing
                ...
                >
                    ...
                    ${this.usesTooltipLabels() && panelActive ? b`
                            <pk-tooltip
...
__decorate([n({ reflect: true })], PkImageBrowser.prototype, "size", void 0);
__decorate([n({ reflect: true })], PkImageBrowser.prototype, "mode", void 0);
__decorate([n({ reflect: true })], PkImageBrowser.prototype, "width", void 0);
__decorate([n({
	reflect: true,
...
__decorate([n()], PkImageBrowser.prototype, "value", void 0);
__decorate([n({ attribute: "default-value" })], PkImageBrowser.prototype, "defaultValue", void 0);
__decorate([n()], PkImageBrowser.prototype, "placeholder", void 0);
...
__decorate([n({ attribute: false })], PkImageBrowser.prototype, "items", void 0);
__decorate([n({ attribute: false })], PkImageBrowser.prototype, "groups", void 0);
__decorate([n({ attribute: "selected-label" })], PkImageBrowser.prototype, "selectedLabel", void 0);
__decorate([n({ attribute: "selected-preview" })], PkImageBrowser.prototype, "selectedPreview", void 0);
__decorate([n({ reflect: true })], PkImageBrowser.prototype, "placement", void 0);
__decorate([n({
	type: Number,
...
__decorate([r()], PkImageBrowser.prototype, "query", void 0);
__decorate([r()], PkImageBrowser.prototype, "limit", void 0);
__decorate([r()], PkImageBrowser.prototype, "closing", void 0);
__decorate([r()], PkImageBrowser.prototype, "panelAnimated", void 0);
__decorate([r()], PkImageBrowser.prototype, "highlightedIndex", void 0);
__decorate([r()], PkImageBrowser.prototype, "tooltipFor", void 0);
__decorate([r()], PkImageBrowser.prototype, "tooltipContent", void 0);
__decorate([e$1(".value-input")], PkImageBrowser.prototype, "input", void 0);
__decorate([e$1(".trigger")], PkImageBrowser.prototype, "triggerElement", void 0);
__decorate([e$1(".control")], PkImageBrowser.prototype, "controlElement", void 0);
__decorate([e$1("pk-popup")], PkImageBrowser.prototype, "popupElement", void 0);
__decorate([e$1(".panel")], PkImageBrowser.prototype, "panelElement", void 0);
__decorate([e$1(".panel-input")], PkImageBrowser.prototype, "searchInput", void 0);
__decorate([e$1(".panel-body")], PkImageBrowser.prototype, "panelBody", void 0);
__decorate([e$1(".option-tooltip")], PkImageBrowser.prototype, "optionTooltip", void 0);
