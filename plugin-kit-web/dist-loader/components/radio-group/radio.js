	...
	render() {
		...
		return b`
			...
			"item--with-label": this.hasDefaultSlotContent
                ...
                data-state=${this.checked ? "checked" : A}
...
__decorate([n()], PkRadio.prototype, "value", void 0);
__decorate([n({
	type: Boolean,
	reflect: true
...
__decorate([n({ type: Number })], PkRadio.prototype, "tabIndex", void 0);
__decorate([n({ attribute: "aria-label" })], PkRadio.prototype, "ariaLabel", void 0);
__decorate([n({
	type: Boolean,
	attribute: false
