...
<pk-time-picker invalid value="99:99"></pk-time-picker>`.trim(),
    ...
    'tiptap-editor-text-styles': `<pk-tiptap-editor buttons="font-family,font-size,bold,italic,small-caps,text-color,line-height,clear-format" value='[{"type":"paragraph","content":[{"type":"text","text":"Select some text, then try the TextStyle menus."}]}]'></pk-tiptap-editor>`,
