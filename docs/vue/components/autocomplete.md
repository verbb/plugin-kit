...
Consumers supply `Option` children (or `async` + `fetchOptions`).
...
<ComponentPreview src="./examples/autocomplete-basic.preview.vue.ts" />

## Clearable

<ComponentPreview src="./examples/autocomplete-clearable.preview.vue.ts" />

## Grouped suggestions

Organize suggestions with labeled option groups when the list benefits from sections.

<ComponentPreview src="./examples/autocomplete-grouped.preview.vue.ts" />
...
<ComponentPreview src="./examples/autocomplete-async.preview.vue.ts" />
...
<ComponentPreview src="./examples/autocomplete-field-warning.preview.vue.ts" />
...
| `loopFocus` | Whether arrow-key focus loops from the last option back to the first (and vice versa). Default: `true` (same as Combobox).<br><small><strong>Type</strong> <code>boolean</code></small><br><small><strong>Default</strong> <code>true</code></small> |
