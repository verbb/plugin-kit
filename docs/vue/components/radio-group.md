...
<ComponentPreview src="./examples/radio-group-basic.preview.vue.ts" />
...
<ComponentPreview src="./examples/radio-group-supporting-descriptions.preview.vue.ts" />

## Disabled Options

Disable individual options when the broader choice is valid but one route is unavailable in the current context.

<ComponentPreview src="./examples/radio-group-disabled-options.preview.vue.ts" />

## Layout and Error

Use horizontal layout for compact choices, and apply invalid state to the group when validation fails.

<ComponentPreview src="./examples/radio-group-layout-error.preview.vue.ts" />
