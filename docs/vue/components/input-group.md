...
<ComponentPreview src="./examples/input-group-icon.preview.vue.ts" />

## Text Addons

Prefix and suffix copy via `InputGroupText` inside aligned addons.

<ComponentPreview src="./examples/input-group-text.preview.vue.ts" />

## Button Addon

Combine a text prefix with an inline `InputGroupButton`.

<ComponentPreview src="./examples/input-group-button.preview.vue.ts" />
