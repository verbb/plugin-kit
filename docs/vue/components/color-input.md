...
<ComponentPreview src="./examples/color-input-basic.preview.vue.ts" />
...
<ComponentPreview src="./examples/color-input-resolved.preview.vue.ts" />

## Sizes

The color input should scale cleanly across the shared size system.

<ComponentPreview src="./examples/color-input-sizes.preview.vue.ts" />
...
<ComponentPreview src="./examples/color-input-states.preview.vue.ts" />
