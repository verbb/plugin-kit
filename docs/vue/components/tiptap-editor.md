...
<ComponentPreview src="./examples/tiptap-editor-basic.preview.vue.ts" />
...
<ComponentPreview src="./examples/tiptap-editor-expanded-toolbar.preview.vue.ts" />

## Toolbar Controls and Extensions

See the canonical [toolbar control reference](/web/components/tiptap-editor#available-toolbar-controls) for every built-in control ID. Custom nodes, marks, TextStyle attributes, and toolbar controls use the framework-neutral [TipTap extensibility API](/web/guides/tiptap-extensibility); register them before mounting the Vue component.
...
<ComponentPreview src="./examples/tiptap-editor-grouped-toolbar.preview.vue.ts" />
