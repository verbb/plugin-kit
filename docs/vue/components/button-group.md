...
<ComponentPreview src="./examples/button-group-basic.preview.vue.ts" />
...
<ComponentPreview src="./examples/button-group-menu-trigger.preview.vue.ts" />

## Separators

Separators are **on by default** — a 1px divider between joined controls. Set `separators="false"` for a flush join.

<ComponentPreview src="./examples/button-group-separators.preview.vue.ts" />
...
<ComponentPreview src="./examples/button-group-split-actions.preview.vue.ts" />

## Sizes

Button groups should scale cleanly with the shared button size system so they can fit toolbars and denser control areas.

<ComponentPreview src="./examples/button-group-sizes.preview.vue.ts" />
...
<ComponentPreview src="./examples/button-group-orientation.preview.vue.ts" />
...
<ComponentPreview src="./examples/button-group-other-controls.preview.vue.ts" />
...
<ComponentPreview src="./examples/button-group-dropdown.preview.vue.ts" />
...
<ComponentPreview src="./examples/button-group-popover.preview.vue.ts" />
