...
If the screen is still just a handful of bespoke React controls and does not benefit from PHP-defined schema, stop using this recipe and follow [Compose a Form with Field Primitives](/react/recipes/compose-a-form-with-field-primitives) instead.
