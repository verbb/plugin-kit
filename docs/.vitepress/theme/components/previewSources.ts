...
const previewModules = {
    ...import.meta.glob('../../../**/*.preview.tsx'),
    ...import.meta.glob('../../../**/*.preview.web.ts'),
    ...import.meta.glob('../../../**/*.preview.vue.ts'),
};

const previewSourceModules = {
    ...import.meta.glob('../../../**/*.preview.tsx', {
        query: '?raw',
        import: 'default',
    }),
...
function resolveDefinitionCode(definition: PreviewSourceDefinition, rawSource?: string) {
    ...
    return definition.code || ('html' in definition ? definition.html : '') || '';
}
