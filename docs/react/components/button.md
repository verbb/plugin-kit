...
<ComponentPreview src="./examples/button-variants.preview.tsx" />
...
<ComponentPreview src="./examples/button-sizes.preview.tsx" />
...
<ComponentPreview src="./examples/button-icons.preview.tsx" />
...
| Name | Description |
| --- | --- |
| `ariaLabel` | Accessible name — wins over title when both are set.<br><small><strong>Type</strong> <code>string \| null</code></small><br><small><strong>Default</strong> <code>null</code></small> |
...
| `groupTrigger` | Compact chevron-only trigger for grouped split actions — Craft `.menubtn`. Not a variant or size: set this boolean on the disclosure end-cap in a split group. Hides label/icons and draws a CSS `::after` chevron (0.4375rem, 2px borders). Inherits `variant`/`size` from sibling buttons; inline padding narrows to 8px. Do not pass a chevron icon — use `icon` + a start-slot icon for a padless square control.<br><small><strong>Type</strong> <code>boolean</code></small><br><small><strong>Default</strong> <code>false</code></small> |
...
| `spinnerSize` | Override loading spinner size. When unset, derived from `size` via `getButtonSpinnerSize` — same defaults as v1 Button (xxs/xs → xxs, lg/xl → sm, else xs). Formie New Form passes `xs` on `size="lg"` so the ring stays size-4 (1rem), not sm (1.5rem).<br><small><strong>Type</strong> <code>PkSpinnerSize \| undefined</code></small> |
| `spinnerTone` | Loading spinner tone. Defaults from the button variant when unset.<br><small><strong>Type</strong> <code>PkSpinnerTone \| undefined</code></small> |
| `spinnerVariant` | Loading spinner visual style. Defaults from the button variant when unset.<br><small><strong>Type</strong> <code>PkSpinnerVariant \| undefined</code></small> |
...
| `withCaret` | Shows a disclosure caret after the label.<br><small><strong>Type</strong> <code>boolean</code></small><br><small><strong>Default</strong> <code>false</code></small> |
