...
export function ImageBrowserIconsInlineExample() {
    ...
    return (
        <ImageBrowser
            ...
            items={[
                ...
                { value: 'heart', label: 'Heart Outline', preview: heartSvg },
                { value: 'bolt', label: 'Lightning Bolt', preview: boltSvg },
                { value: 'leaf', label: 'Add Parent Node', preview: leafSvg },
            ]}
        />
    );
}
...
const preview: PreviewSourceDefinition = {
    ...
    language: 'tsx',
    source: true,
    render: () => <ImageBrowserIconsInlineExample />,
};
