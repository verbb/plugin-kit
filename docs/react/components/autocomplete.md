...
<ComponentPreview src="./examples/autocomplete-basic.preview.tsx" />

## Clearable

<ComponentPreview src="./examples/autocomplete-clearable.preview.tsx" />

## Grouped suggestions

Organize suggestions with labeled option groups when the list benefits from sections.

<ComponentPreview src="./examples/autocomplete-grouped.preview.tsx" />
...
<ComponentPreview src="./examples/autocomplete-async.preview.tsx" />
