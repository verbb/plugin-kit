...
| Name | Description |
| --- | --- |
| `onChange` | User commits a new value |
| `onInput` | Value changes during interaction |
| `onPkFocusDay` | Focused day changed; `detail.date` |
| `onPkViewChange` | View changed; `detail.view`, `detail.date` |
