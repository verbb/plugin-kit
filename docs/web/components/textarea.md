...
<ComponentPreview src="./examples/textarea-basic.preview.web.ts" />
...
<ComponentPreview src="./examples/textarea-sizes.preview.web.ts" />
...
| `maxlength` `max-length` | <small><strong>Type</strong> <code>number \| undefined</code></small> |
