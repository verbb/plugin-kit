...
CodeEditor provides a monospace code surface for HTML or plain text, built on [CodeMirror 6](https://codemirror.net/) via `@verbb/plugin-kit-codemirror-core` (shared with the `<pk-code-editor>` web component).
...
<ComponentPreview src="./examples/code-editor-states.preview.web.ts" />
...
| `lineNumbers` `line-numbers` | <small><strong>Type</strong> <code>boolean</code></small><br><small><strong>Default</strong> <code>true</code></small> |
...
| `tabSize` `tab-size` | <small><strong>Type</strong> <code>number</code></small><br><small><strong>Default</strong> <code>4</code></small> |
