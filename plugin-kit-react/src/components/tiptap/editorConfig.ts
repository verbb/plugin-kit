...
export const createTiptapExtensions = ({
    ...
    return [
        ...
        VariableTag.configure({ trailingCursorText }),
    ];
};
...
const withTrailingCursorText = (
    ...
    // The placeholder belongs in the editable document model, not stored content.
    // It gives inline atom nodes a real text position for browser caret painting.
