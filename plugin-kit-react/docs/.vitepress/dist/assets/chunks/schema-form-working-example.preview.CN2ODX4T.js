...
);`,R={label:"Working Form Example",title:"Working form example",language:"tsx",note:"Preview includes a native form wrapper, submit button, live values, and submitted payload.",code:S,render:()=>e.jsx(x,{})};export{R as default};
