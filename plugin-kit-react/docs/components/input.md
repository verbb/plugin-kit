...
`Input` wraps [Base UI Input](https://base-ui.com/react/components/input/). Use the Base UI API reference for native input behavior and accessibility details inherited by the component.
