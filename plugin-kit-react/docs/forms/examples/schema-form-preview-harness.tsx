...
import { VariableCategoriesProvider } from '../../../src/forms';
import { SchemaFormEngine, useSchemaFormEngine } from '../../../src/forms';
import type { FieldEntry, SchemaNode } from '../../../src/forms/engine/SchemaIndex';
    ...
    return (
        <div style={previewShellStyle}>
            <div style={previewContentStyle}>
                <VariableCategoriesProvider value={mockVariableContext}>
