...
String-backed code editing using the [`CodeEditor`](../../components/code-editor.md) component and [`FieldLayout`](../schema-fields.md#field-anatomy), with [`useEngineField`](../../api/schema-form-api.md) for store binding.
...
| `language` | `'html' \| 'text'` | `'html'` | Editor language mode. |
...
- Plain component docs: [CodeEditor](../../components/code-editor.md)
- Rich text alternative: [RichTextField](./rich-text-field.md)
- Read-only rich text previews: [TiptapContent](../../components/tiptap-content.md)
