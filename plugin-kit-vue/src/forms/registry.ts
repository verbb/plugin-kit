...
// Custom field overrides and third-party field types. Built-ins resolve lazily on first render.
...
export const getFormComponentRegistry = (): Record<string, SchemaFormComponent> => {
